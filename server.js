...
const PROPERTY_DATA = {
  ...
  'regent-skyline': {
    ...
    photoLabels: ['Living Room','Living Room Alternate View','Exposed Brick Walls','Sofa Seating','Accent Lighting','Smart TV','Dining Area','Downtown Dallas View','Kitchen Overview','Full Kitchen','Kitchen Counter','Coffee Station','Kitchen Detail','Dining Table','Spices & Cookware','Microwave','Bedroom','Bed Linens','Bedroom Decor','Smart TV (Bedroom)','Nightstand','Pillows & Bedding','Bedroom Lighting','Bedroom Detail','Room-darkening Shades','Full-length Mirror','Bathroom','Clothing Storage','Bathroom Vanity','Shower','Bathroom Detail','Hallway','Entry Area','Interior Detail','Premium LED Lighting','Accent Decor','Board Games','Dedicated Workspace','Desk Setup','High-speed Internet','Washer & Dryer','Laundry Area','Storage Area','Fitness Center','Resort Pool','Pool Lounge','Courtyard','Cinema Room','Cinema Seating','Karaoke Lounge','Art & Music Studio','Game Room','Co-working Space','Arcade Room','Building Lobby','Meeting Room','Building Common Area','Building Exterior','Property Entrance'],
    photos: [
