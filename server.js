...
const PROPERTY_DATA = {
  ...
  'executive': {
    ...
    photoLabels: ['Living Room','Star Projector','Electric Fireplace','75" Smart TV','Media Console','Fireplace & Star Ceiling','Board Games','Dining Area','Living Room Sectional','Coffee Maker','Full Kitchen','Kitchen Counter','Sink & Utensils','Kitchen Decor','Cookware','Microwave','Open Concept','Nightstand','Bedroom Decor','Full-length Mirror','Walk-in Closet','Hair Dryer','Bathroom','Bathroom Vanity','Workspace','Workspace Detail','Patio','Outdoor Seating','Gym with Spin Room','Pool with Tanning Ledge','Sky Lounge','Co-working Spaces','Arcade Games','Pool Table'],
    photos: [
